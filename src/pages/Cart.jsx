...
function Cart() {
  ...
  const handleCart =()=>{
    dispatch(emptyCart())
    alert("Your Order Placed Succesfully.....Thank You For Purchasing")
    navigate('/')
  }
    ...
    <div style={{marginTop:'100px'}}>
      {
              ...
              <tbody>
                {
                  cartArray.map((product,index)=>(
                    <tr key={index}>
                      ...
                      <td>${product.price}</td>
                      <td> <Button onClick={()=>dispatch(removeFromCart(product.id))} className='btn btn light' ><i class="fa-solid fa-trash" style={{color:'red'}}></i></Button></td>
        ...
        : <div style={{height:'100vh'}} className='w-100 d-flex flex-column justify-content-center align-items-center'>
         ...
         <h3 className='text-center text-danger'>Cartlist Is Empty!!</h3>
